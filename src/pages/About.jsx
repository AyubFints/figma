    ...
    <section className="container">
      <div className="certificate">
        <div className="cert-content">
          <p className="subtitle">CREATE X CERTIFICATE</p>
          <h1 className="title">Your expertise will be confirmed</h1>
          <p className="desc">
        ...
        <div className="team-grid">
          <div className="card">
            <div className="img-box">
              <img src={image} alt="Dianne Russell" />
            </div>
          ...
          <div className="card">
            <div className="img-box">
              <img src={image} alt="Kristin Watson" />
            </div>
          ...
          <div className="card">
            <div className="img-box">
              <img src={image} alt="Marvin McKinney" />
            </div>
      ...
      <div className="blog-konteyner">
        ...
        <div className="blog-panjara">
          <div className="blog-karta">
            <div className="rasm-qutisi ko'k">
